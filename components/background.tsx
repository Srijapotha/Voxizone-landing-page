...
export const Background = () => {
  return (
    <div className="pointer-events-none absolute inset-0 z-0 h-full w-full">
      <div className="pointer-events-none absolute inset-0 h-full w-full bg-neutral-100 [mask-image:radial-gradient(ellipse_at_center,transparent,white)] dark:bg-neutral-950" />
